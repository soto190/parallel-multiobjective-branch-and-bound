...
void Solution::setObjective(int index_obj, double value) throw(SolutionException){
    try{
        if (index_obj > n_objectives - 1)
            throw SolutionException(SolutionErrorCode::OBJECTIVES_OUT_OF_RANGE, "when calling setObjective(row:" + std::to_string(static_cast<long long>(index_obj)) + ", value:" + std::to_string(static_cast<long long>(value)) + ")");
...
int Solution::setVariable(int index_variable, int value) throw(SolutionException){
    try {
        if (index_variable > n_variables - 1)
            throw SolutionException(SolutionErrorCode::VARIABLES_OUT_OF_RANGE, "when calling setVariable(row:" + std::to_string(static_cast<long long>(index_variable)) + ", value:" + std::to_string(static_cast<long long>(value)) + ")");
...
double Solution::getObjective(int index_obj) const throw(SolutionException){
    try{
        if (index_obj > n_objectives - 1)
            throw SolutionException(SolutionErrorCode::OBJECTIVES_OUT_OF_RANGE, "when calling getObjective(row:" + std::to_string(static_cast<long long>(index_obj)) + ")");
...
int Solution::getVariable(int index_variable) const throw(SolutionException){
    try {
        if (index_variable > n_variables - 1)
            throw SolutionException(SolutionErrorCode::VARIABLES_OUT_OF_RANGE, "when calling getVariable(row:" + std::to_string(static_cast<long long>(index_variable)) + ")");
